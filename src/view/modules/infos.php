    ...
    <form method="post" action="/account/update">
        <table>
            ...
            <tr>
                ...
                <td><a onclick="show1()" style="color: blue" id="link1">Modifier</a></td>
            </tr>
            <tr>
                <td>Nom</td>
                <td><input type="text" name="lastname" value="<?= $_SESSION['login']['lastname']?>" disabled id="input2"></td>
                <td><a  style="color: blue"  onclick="show2()" id="link2">Modifier</a></td>
            </tr>
            <tr>
                <td>Adresse mail</td>
                <td><input type="text" name="mail" value="<?= $_SESSION['login']['mail']?>" disabled id="input3"></td>
                <td><a onclick="show3()" style="color: blue" id="link3" >Modifier</a></td>
            </tr>
            <tr></tr>
...
<?php endif; ?>
            ...
            <div id="btn-update" style="margin: 68px 835px; visibility: hidden"><input type="submit" value="Modifier mes informations"></div>
